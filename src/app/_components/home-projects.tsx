...
export const HomeProjects = () => {
    ...
    return <section data-aos="fade-up" data-aos-duration="2000" id="portfolio" className="bg-body z-1">
        <Container>
            <div data-aos="fade-up" data-aos-duration="2000" className="space-y-[31.5px] py-7.5">
                ...
                <Group data-aos="fade-up" data-aos-duration="2000" direction="row" items="center" className="gap-7">
                    <CustomLink className="z-1" href={{
                        ...
                        size="20"
                        color={filterByStack === "all" ? "defaut" : "sky"}
                    >
                        Все работы
                    </CustomLink>
                    ...
                    <CustomLink  className="z-1" href={{
                        ...
                        size="20"
                        color={filterByStack === "html" ? "defaut" : "sky"}
                    >
                        HTML верстка
                    </CustomLink>
                    ...
                    <CustomLink className="z-1" href={{
                        ...
                        size="20"
                        color={filterByStack === "wp" ? "defaut" : "sky"}
                    >
                        WordPress
                    </CustomLink>
                </Group>
...
"
                >
                    {
                        hasProjects ? filteredProject.map(item => <HomeProject key={item.id} projectData={item} />) :
                            <p>
